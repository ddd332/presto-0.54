 ...
 */
/*
Update: Tao Yang, add --language options to choose between sparql and sql
Date: 2014.01.06
 */
...
public class ClientOptions
{
    ...
    @Option(name = "--language", title = "language", description = "presto input language (default: SQL)")
    ...
    {
        return new ClientSession(parseServer(server), user, "presto-cli", catalog, schema, debug, language);
    }
