...
public final class FormatUtils
{
    ...
    public static void main(String args[]){
        Duration duration = new Duration(123456, MILLISECONDS);
        for(int i = 0 ; i < 10 ; i ++){
    ...
    */
    ...
    {
        int totalMillions = Ints.saturatedCast(duration.roundTo(MILLISECONDS));
        ...
        /**
         * Attention: Bug here
         * where using second return format get the total million seconds, print an extra line when state refreshes!
         * Fixed- 2014.5.8
         * Reason: maybe some tricks in parse the format, is ok when there's no "," in format sentence
         */
//        return format("%s:%02d ", minutes, seconds);
        return format("%s:%02d  %s", minutes, seconds, totalMillions);
    }
