        ...
        extends Expression
{
    ...
    /**
     * Add this method to get prefix(table) of this name.
     * Second parameter in getFirst() is the default value returned if there's no available one.
     * Tao Yang
     * 2014/05/25
     */
    public QualifiedName getPrefix(){
        return QualifiedName.of(Iterables.getFirst(name.getParts(), name.toString()));
    }
